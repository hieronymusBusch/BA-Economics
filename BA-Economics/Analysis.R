...
summary (log1.1)
exp(coef(log1.1))
reg1.2.2 <- lm(addSupGRANTamountHH2 ~ councilLeft, data=dfddProgNoSt)
summary (reg1.2.2)
...
summary (log1.3)
exp(coef(log1.3))
reg1.4.2 <- lm(addSupGRANTamountHH2 ~ councilFem, data=dfddProgNoSt)
summary (reg1.4.2)
...
summary (log1.5)
exp(coef(log1.5))
reg1.6.2 <- lm(addSupGRANTamountHH2 ~ parlFem, data=dfddProgNoSt)
summary (reg1.6.2)
...
summary (log1.7)
exp(coef(log1.7))
reg1.8.2 <- lm(addSupGRANTamountHH2 ~ councilChange, data=dfddProgNoSt)
summary (reg1.8.2)
...
summary (log1.9)
exp(coef(log1.9))
reg1.10.2 <- lm(addSupGRANTamountHH2 ~ turnout, data=dfddProgNoSt)
summary (reg1.10.2)
...
reg1.a.2 <- lm(addSupGRANTamountHH2 ~ councilLeft + parlFem + councilFem + councilChange + turnout, data=dfddProgNoSt)
summary (reg1.a.2)
...
summary (log2.1)
exp(coef(log2.1))
reg2.2.2 <- lm(addSupGRANTamountHH2 ~ popDensityHun, data=dfddProgNoSt)
summary (reg2.2.2)
...
summary (log2.3.1)
exp(coef(log2.3.1))
reg2.4.2.1 <- lm(addSupGRANTamountHH2 ~ unemployment, data=dfddProgNoSt)
summary (reg2.4.2.1)

log2.3.2 <- glm(addSup ~ hhHousingSup, data=dfddProgNoSt, family=binomial)
summary (log2.3.2)
exp(coef(log2.3.2))
reg2.4.2.2 <- lm(addSupGRANTamountHH2 ~ hhHousingSup, data=dfddProgNoSt)
summary (reg2.4.2.2)
...
summary (log2.5)
exp(coef(log2.5))
reg2.6.2 <- lm(addSupGRANTamountHH2 ~ cathShare, data=dfddProgNoSt)
summary (reg2.6.2)
...
reg2.a.2 <- lm(addSupGRANTamountHH2 ~ popDensityHun + unemployment + progState + cathShare, data=dfddProg)
summary (reg2.a.2)
reg2.b.2 <- lm(addSupGRANTamountHH2 ~ popDensityHun + hhHousingSup + progState + cathShare, data=dfddProg)
summary (reg2.b.2)
...
summary (log3.1)
exp(coef(log3.1))
reg3.2.2 <- lm(addSupGRANTamountHH2 ~ GDPpc, data=dfddProgNoSt)
summary (reg3.2.2)
...
summary (log3.3)
exp(coef(log3.3))
reg3.4.2 <- lm(addSupGRANTamountHH2 ~ debtpcHun, data=dfddProgNoSt)
summary (reg3.4.2)
...
summary (log3.a)
exp(coef(log3.a))
reg3.a.2 <- lm(addSupGRANTamountHH2 ~ GDPpc + debtpcHun, data=dfddProg)
summary (reg3.a.2)
...
# Variables
stargazer(dfddProg[c("addSupLOANamount","addSupGRANTamountHH1","addSupGRANTamountHH2")], 
